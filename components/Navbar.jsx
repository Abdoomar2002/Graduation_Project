...
export default function NavBar({ navigation, active }) {
  ...
  return (
    <View style={style.conatiner}>
      ...
      <Pressable style={style.center} onPress={() => HandelPress("Order")}>
        <FontAwesome
          name="plus"
          size={30}
          color={activePage == "Order" ? "#0084ff" : "black"}
          style={[style.img]}
        />
      </Pressable>
      <Pressable onPress={() => HandelPress("Order")}>
        <FontAwesome
          name="plus"
          size={30}
          color={activePage == "Order" ? "#0084ff" : "white"}
          style={[style.img]}
        />
      </Pressable>
      <Pressable
