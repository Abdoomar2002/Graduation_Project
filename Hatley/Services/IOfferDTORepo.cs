...
namespace Hatley.Services
{
	public interface IOfferDTORepo
	{
		...
		int UserAcceptOffer(int orederid, double price_of_offer, string email, string? offer_id);
		int UserDeclineOffer(int orederid, double price_of_offer, string email, string? offer_id);
